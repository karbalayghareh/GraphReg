                ...
                if data_exist:
                    if tf.reduce_sum(tf.gather(tss_idx, idx)) > 0:
                        if (pos[0] > 0 and pos[-1] < 1e15  and gene_tss_list[i] >= pos[0]+2000000 and gene_tss_list[i] < pos[0]+4000000):
                            ...
                            if write_bw == True:
                                bw_flowfish = pyBigWig.open('/media/labuser/STORAGE/GraphReg/results/bigwig/feature_attribution/Epi-models/flowfish_'+cell_line+'_'+gene_names_list[i]+'.bw', "w")
                                ...
                                cnt = -1
                                with open('/media/labuser/STORAGE/GraphReg/results/bigwig/feature_attribution/Epi-models/candidates_'+cell_line+'_'+gene_names_list[i]+'.bed', "w") as bed_file:
