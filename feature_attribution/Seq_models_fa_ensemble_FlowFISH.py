                        ...
                        if (pos[0] > 0 and pos[-1] < 1e15  and gene_tss_list[i] >= pos[0]+2000000 and gene_tss_list[i] < pos[0]+4000000):
                            ...
                            if saliency_method == 'saliency':
                                if load_fa == False:
                                    ...
                                    np.save('/media/labuser/STORAGE/GraphReg/results/numpy/feature_attribution/Seq-CNN_'+saliency_method+'_'+cell_line+'_'+gene_names_list[i]+'.npy', grads_cnn)
                                else:
                            ...
                            if saliency_method == 'saliency':
                                if load_fa == False:
                                    ...
                                    np.save('/media/labuser/STORAGE/GraphReg/results/numpy/feature_attribution/Seq-GraphReg_'+saliency_method+'_'+cell_line+'_'+gene_names_list[i]+'.npy', grads_gat)
                                else:
                                    grads_gat = np.load('/media/labuser/STORAGE/GraphReg/results/numpy/feature_attribution/Seq-GraphReg_'+saliency_method+'_'+cell_line+'_'+gene_names_list[i]+'.npy')
                            ...
                            if write_bw == True:
                                bw_flowfish = pyBigWig.open('/media/labuser/STORAGE/GraphReg/results/bigwig/feature_attribution/Seq-models/flowfish_'+cell_line+'_'+gene_names_list[i]+'.bw', "w")
                                bw_flowfish.addHeader(header)
                                bw_abc = pyBigWig.open('/media/labuser/STORAGE/GraphReg/results/bigwig/feature_attribution/Seq-models/abc_'+cell_line+'_'+gene_names_list[i]+'.bw', "w")
                                bw_abc.addHeader(header)
                                bw_GraphReg = pyBigWig.open('/media/labuser/STORAGE/GraphReg/results/bigwig/feature_attribution/Seq-models/Seq-GraphReg_'+saliency_method+'_'+cell_line+'_'+gene_names_list[i]+'.bw', "w")
                                bw_GraphReg.addHeader(header)
                                bw_CNN = pyBigWig.open('/media/labuser/STORAGE/GraphReg/results/bigwig/feature_attribution/Seq-models/Seq-CNN_'+saliency_method+'_'+cell_line+'_'+gene_names_list[i]+'.bw', "w")
                                ...
                                cnt = -1
                                with open('/media/labuser/STORAGE/GraphReg/results/bigwig/feature_attribution/Seq-models/candidates_'+cell_line+'_'+gene_names_list[i]+'.bed', "w") as bed_file:
...
plt.figure(figsize=(15,15))
plt.plot(recall_gat, precision_gat, color='red', label="Seq-GraphReg: AUC = "+str(auprc_gat_all.astype(np.float16)))
plt.plot(recall_cnn, precision_cnn, color='green', label="Seq-CNN: AUC = "+str(auprc_cnn_all.astype(np.float16)))
...
print('Seq-GraphReg SP for significants: ', spearmanr(gat_fa_all[idx], expr_change_percent_all[idx])[0])
print('Seq-CNN SP for significants: ', spearmanr(cnn_fa_all[idx], expr_change_percent_all[idx])[0])
